...
<form action="../musica/musica_insere.php" enctype="multipart/form-data" class="text-bg-dark container" method="post">
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="input-group mb-3">
                <label class="input-group-text" for="capa">Upload</label>
                <input type="file" class="form-control" id="capa" name="capa">
            </div>
        </div>
        <div class="row">
            <button type="submit" class="btn btn-outline-success" style="width: 100px; margin: 1rem auto"
                value="ins">Inserir</button>
        </div>
</form>
